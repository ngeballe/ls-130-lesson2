...
class TodoListTest < MiniTest::Test
  ...
  def test_size
    ...
    assert_equal(0, TodoList.new("Empty List").size)
  end
  ...
  def test_all_done
    ...
    assert_equal(@list.all_done.to_a, [@todo1, @todo3])
  end

  def test_all_not_done
    @todo3.done!

    assert_equal(@list.all_not_done.to_a, [@todo1, @todo2])
  end
